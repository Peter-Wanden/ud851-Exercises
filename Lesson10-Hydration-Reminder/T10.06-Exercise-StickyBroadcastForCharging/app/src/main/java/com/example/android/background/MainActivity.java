...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            int battStat = batteryStatus.getIntExtra(BatteryManager.EXTRA_STATUS, -1);
            boolean isCharging = battStat == BatteryManager.BATTERY_STATUS_CHARGING ||
                    battStat == BatteryManager.BATTERY_STATUS_FULL;
