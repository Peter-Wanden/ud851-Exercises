...
public class MainActivity extends AppCompatActivity {
    ...
    // Word and definition column indexes
    private int mWordCol, mDefinitionCol;
    private TextView mWordTV, mDefinitionTV;
    ...
    public void nextWord() {
        ...
        if (mData != null) {
            // If there is one, move to the next position in the cursor, if not move to first
            if (!mData.moveToNext()) {
                mData.moveToFirst();
            }
            ...
            // get the next word and definition
            mWordTV.setText(mData.getString(mWordCol));
            mDefinitionTV.setText(mData.getString(mDefinitionCol));
